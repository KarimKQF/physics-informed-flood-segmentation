...
### Split: `train` (100 tiles, 100 with shuffle)

| Metric | Real (mean±std) | Shuffled (mean±std) | Delta (real−shuffled) | % tiles real better |
|--------|----------------|--------------------|-----------------------|---------------------|
| Current-loss violation (↓) | 0.0029 ± 0.0048 | 0.0062 ± 0.0086 | -0.0033 ± 0.0052 | 76.0% |
| D8 violation (↓) | 0.0035 ± 0.0057 | 0.0074 ± 0.0100 | -0.0039 ± 0.0058 | 78.0% |
| Elevation delta dry−water (↑) | 16.1890 ± 27.5968 | -1.5542 ± 16.8217 | 17.7432 ± 35.3969 | 81.4% |
| Elevation AUC (↑) | 0.7847 ± 0.1509 | 0.5086 ± 0.1425 | 0.2761 ± 0.2210 | 88.4% |

## Overall Summary

- Total tiles processed: 100
- Tiles with shuffle comparison: 100
- Splits: ['train']

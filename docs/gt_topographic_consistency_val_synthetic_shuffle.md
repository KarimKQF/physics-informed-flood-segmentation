...
### Split: `val` (86 tiles, 86 with shuffle)

| Metric | Real (mean±std) | Shuffled (mean±std) | Delta (real−shuffled) | % tiles real better |
|--------|----------------|--------------------|-----------------------|---------------------|
| Current-loss violation (↓) | 0.0029 ± 0.0040 | 0.0049 ± 0.0058 | -0.0020 ± 0.0037 | 77.9% |
| D8 violation (↓) | 0.0033 ± 0.0046 | 0.0060 ± 0.0072 | -0.0027 ± 0.0044 | 81.4% |
| Elevation delta dry−water (↑) | 12.1536 ± 31.4703 | 2.0790 ± 23.4573 | 10.0746 ± 40.2991 | 84.4% |
| Elevation AUC (↑) | 0.8024 ± 0.1844 | 0.4817 ± 0.1843 | 0.3207 ± 0.2687 | 90.9% |

## Overall Summary

- Total tiles processed: 86
- Tiles with shuffle comparison: 86
- Splits: ['val']
